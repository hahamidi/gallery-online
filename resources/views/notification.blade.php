                                ...
                                @foreach($data as $follower)
                                     <div class="list" id="list" data-searchable="data-searchable">
                                         <a class="list-item" href="#">
                                             ...
                                             <strong style="font-size:10px !important;" class="list-item__name"> {{ $follower->name}}</strong>
                                             </div>
                                            <button style="width:auto; height:auto;float:left;margin-left:10px;font-size:15px;"  data-id="{{ $follower->notifid}}" data-toggle="modal" data-target=".unfollow" onclick="unfollow(this)">accept</button>
                                             <p style="font-size:10px;margin:10px;">{{ $follower->created_at}}</p>
                                         </a>
                                @endforeach
